...
<div class="cadastro-cliente">
    <h3 class="page-header">Ajouter un Responsable</h3>
...
if (isset($_GET['err'])) {
    if (($_GET['err']) == 1) {
        echo '<button name="error" class="btn btn-success" onclick="return false;">Ce Responsable a été bien ajouté ✅</button>';
    } 
}
?>
<hr>
