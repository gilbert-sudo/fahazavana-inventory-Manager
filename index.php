...
<body class="login-page sidebar-collapse">
    ...
    <div class="page-header header-filter" style="background-image: url('img/far.WEBP'); background-size: cover; background-position: top center;">
        <div class="container" align="center">

            <div class="col-lg-4 col-md-6 ml-auto mr-auto" style="max-width: 500px">
                <div class="logo text-center">

                    <img src="img.ico" class="card-title">
